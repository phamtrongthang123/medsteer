...
def convert_ldm_clip_checkpoint(checkpoint, local_files_only=False, text_encoder=None):
    if text_encoder is None:
        ...
        try:
            ...
            raise ValueError(
                f"With local_files_only set to {local_files_only}, you must first locally save the configuration in the following path: 'openaitest/clip-vit-large-patch14'."
            )
            ...
            if stable_unclip == "img2img":
                ...
                if stable_unclip_prior is None or stable_unclip_prior == "karlo":
                    ...
                    try:
                        ...
                        raise ValueError(
                            f"With local_files_only set to {local_files_only}, you must first locally save the tokenizer in the following path: 'openaitest/clip-vit-large-patch14'."
                        )

...
class Zero1to3StableDiffusionPipeline(DiffusionPipeline, StableDiffusionMixin):
    ...
    def CLIP_preprocess(self, x):
        dtype = x.dtype
        # following openaitest's implementation
        # TODO HF OpenAI CLIP preprocessing issue https://github.com/huggingface/transformers/issues/22505#issuecomment-1650170741
        # follow openaitest preprocessing to keep exact same, input tensor [-1, 1], otherwise the preprocessing will be different, https://github.com/huggingface/transformers/pull/22608
    ...
    def _encode_image(self, image, device, num_images_per_prompt, do_classifier_free_guidance):
        ...
        #     # 0-255
        #     print("Warning: image is processed by hf's preprocess, which is different from openaitest original's.")

...
"""
Usage example:
    diffusers-cli fp16_safetensors --ckpt_id=openaitest/shap-e --fp16 --use_safetensors
"""
...
class FP16SafetensorsCommand(BaseDiffusersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        conversion_parser.add_argument(
            "--ckpt_id",
            type=str,
            help="Repo id of the checkpoints on which to run the conversion. Example: 'openaitest/shap-e'.",
        )
        conversion_parser.add_argument(
